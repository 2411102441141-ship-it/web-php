<html>
    ...
    <body>
        <h1>baca inputndari form</h1>
        <form action="script6-1proses.php" method="post">
            <table>
                <tr><td>Nama Lengkap</td><td></td><td><input type="text" name="name" size="30"></td></tr>
                <tr><td>Alamat</td><td></td><td><textarea name="alamat" cols="20"></textarea></td></tr>
